...
BASE_MD_DIR: str = os.path.join(execution_folder, "substack_md_files")  # Name of the directory we'll save the .md essay files
BASE_HTML_DIR: str = os.path.join(execution_folder, "substack_html_pages")  # Name of the directory we'll save the .html essay files
HTML_TEMPLATE: str = os.path.join(execution_folder, "author_template.html")  # HTML template to use for the author page
JSON_DATA_DIR: str = os.path.join(execution_folder, "data")
...
class PremiumSubstackScraper(BaseSubstackScraper):
    ...
    def login(self) -> None:
        ...
        email.send_keys(EMAIL_SUBSTACK)
        password.send_keys(PASSWORD_SUBSTACK)
